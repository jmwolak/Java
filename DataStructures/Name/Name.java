...
public class Name implements Comparable<Name> {
	...
	public void setName(String name) {
		...
		if (name == null || name.equals(""))
			...
			throw new RuntimeException("Blank name Setting Attempted");
	...
	public void setSex(String sex) {
		...
		if (sex == null || !sex.equalsIgnoreCase("M") && !sex.equalsIgnoreCase("F"))
			...
			throw new RuntimeException("Bad Gender Setting Attempted: " + sex);
	...
	public void setNumber(int number) {
		...
		if (number < 0)
			...
			throw new RuntimeException("Negative Number Setting Attempted: " + number);
	...
	public String toString() {
		...
		return String.format("%15s, %1s, %,6d", this.name, this.sex, this.number);
	...
	public void addToNumber(int n) {
		...
		if (n < 0)
			...
			throw new RuntimeException("Negative Number Setting Attempted in addToNumber: " + n);

		this.setNumber(this.getNumber() + n);
